export const translations = {
    ar: {
        ...
        transferTextNoFee: "يُرجى تحويل مبلغ {amount} EGP (سعر الملعب) إلى رقم {phone} (فودافون كاش / InstaPay) وارفع صورة التحويل بالأسفل.",
        ...
        contactOwner: "تواصل مع صاحب الملعب",
        contactOwnerWhatsApp: "للتواصل مع صاحب الملعب بخصوص الملعب: {phone}",
    ...
    en: {
        ...
        transferTextNoFee: "Please transfer {amount} EGP (Field Price) to {phone} (Vodafone Cash / InstaPay) and upload the receipt below.",
        ...
        contactOwnerWhatsApp: "To contact the field owner: {phone}",
