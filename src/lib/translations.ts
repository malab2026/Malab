export const translations = {
    ar: {
        ...
        transferText: "يُرجى تحويل مبلغ {amount} EGP شامل (سعر الملعب + {fee} EGP خدمة) إلى رقم {phone} (InstaPay) وارفع صورة التحويل بالأسفل.",
    ...
    en: {
        ...
        transferText: "Please transfer {amount} EGP inclusive of (Field Price + {fee} EGP service fee) to {phone} (InstaPay) and upload the receipt below.",
